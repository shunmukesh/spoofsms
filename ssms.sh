...
printf "e[1;77m  \n"
printf "  ____   ___   __  __ ____\n"
printf " / ___// ___/ |  \/ |/ ___|  \n"
printf " \___ \\___ \ | |\/||\___ \  \n"
printf " |___) ||__) | | | | |___) | \n"
printf " |____/|____/ |_| |_|____ / v1.0 \n"
printf "  \e[0m\e[1;92m Author: @shunmukesh\e[0m\n"
printf "\n"
}
...
mv app/build/outputs/apk/app-release-unsigned.apk spoofsms.apk
echo "      " | apksigner sign --ks key.keystore  spoofsms.apk > /dev/null
